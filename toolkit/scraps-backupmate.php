...
{?>
<center><div class="loltitleclassic"><b><a href="scraps-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>">View as Plain HTML</a>&nbsp;|&nbsp;<i>Download - Coming Soon!</i></b></div></center><br>
<iframe src="scraps-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>" height=100% width="100%" frameborder="0" allowtransparency="true"></iframe><br><br>
<?php
}else{
?>
<form method="POST">
	<div class="loltitleclassic"><b>Your Orkut E-Mail ID</div></b>
	...
	<p><input type="password" name="pass" size="40" value = "Password"></p>
        <p><b>Note</b> - Please wait until the page gets fully loaded.The page will stop loading if Orkut displays 'no more scraps'.</p>
	<p align="left"><input type="submit" value="Create Backup" name="B1">&nbsp;<input type="reset" value="Reset" name="B2"></p>
</form>
<?php } ?>
</div>
<p align="center"><script type="text/javascript"><!--
