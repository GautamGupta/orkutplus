...
if ($orkut_state[0] != NULL){
        /*$dlp = '<html><body><style type="text/css">
body,div,ul,li,input,select,textarea,p,td,h1,h2,h3{color:#000;font-family:Verdana,Arial,sans-serif;font-size:12px;margin:0;padding:0}
.para{font-size:12px;padding:2px 0 3px}
.rfdte{float:right}
h3.smller{font-size:12px;line-height:16px;font-weight:700}
.listimg{margin-bottom:3px;padding:2px}
        ...
        function s($t, $y){
                ...
                //others (blank).2
                $t = str_replace("<a class=\"rbs\" href=\"javascript: void(0);\" id=\"reply_link_".$y."\" onclick=\"_quickReplyOpen(this, ".$y.");\" > &nbsp;Responder</a>", "", $t);
                $t = str_replace("&nbsp;", "", $t);
                //hide 1.2
                ...
                $t = str_replace(")}); return false;\" class=\"btn\">apagar</a></span><span class=\"btnboxr\"><img src=\"http://img1.orkut.com/img/b.gif\" alt=\"\" height=\"1\" width=\"5\"></span>", "\">", $t);
                //hide 2.3
                ...
                $t = str_replace("))._showWindow(); return false;\">Exibir essa conversa</a>","\">",$t);
                //long hide (blank)
                ...
                $t = str_replace("); return false;\" class=\"btn\">enviar recado</a></span><span class=\"btnboxr\"><img src=\"http://img1.orkut.com/img/b.gif\" alt=\"\" height=\"1\" width=\"5\"></span>\n<span class=\"grabtn\"><a  href=\"javascript:void(0);\" onclick=\"_quickReplyCloseAll(); document.getElementById('scrapText_".$y."').value = ''; return false;\" class=\"btn\">cancelar</a></span><span class=\"btnboxr\"><img src=\"http://img1.orkut.com/img/b.gif\" alt=\"\" height=\"1\" width=\"5\"></span>", "\">", $t);
                //chat hide
                ...
                $t = str_replace("');\">Responder com bate-papo</a>\n<span>\n</span>", "\"><input type=\"hidden\" value=\"", $t);
                $t = str_replace("Responder com bate-papo", "", $t);
        ...
        $req->setRequestHeader("Cookie",$orkut_state[0]);
        $req->send(null);
        preg_match('%Scrapbook.aspx([^"]+)">pr'.urldecode("%C3%B3").'xima %', $req->responseText, $find);
        if($find[1] != NULL){
		while(preg_match('%Scrapbook.aspx([^"]+)">pr'.urldecode("%C3%B3").'xima %', $req->responseText, $match)){
        ...
        echo "E-Mail ID não funciona!<br>";
}
?>