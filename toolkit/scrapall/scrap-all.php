...
if(($_POST['email'] != NULL && $_POST['pass'] != NULL && $_POST['scrap'] != NULL) || ($_SESSION['c'] == 1 && $_SESSION['ocookie'] != NULL && $_SESSION['scrap'] != NULL && $_POST['cs'] != NULL))
{
	...
	if ($user_inf['ud_post_token'] != NULL)
	{
		if($_SESSION['c'] != 1)
		{
			...
			/*
			 https://www.google.com/accounts/ServiceLoginAuth?service=orkut ltmpl=mobile&continue=http%3A%2F%2Fm.orkut.com%2FRedirLogin%3Fmsg%3D0%26page%3Dhttp%253A%252F%252Fm.orkut.com%252FHome&service=orkut&cd=US&nui=5&skipvpage=true&sendvemail=false&rm=false&dsh=-7662602796348961979&ltmpl=mobile&btmpl=mobile&hl=en-GB&ltmpl=mobile&GALX=PNXBz6AFa1Y&Email=<REDACTED>&Passwd=<REDACTED>&rmShown=1&signIn=Sign+in

#request# POST https://www.google.com/accounts/ServiceLoginAuth?service=orkut

POST /Scrapbook Action.submit=1&POST_TOKEN=4B510E9870C44BBC7132E6E2AC2DA8A6&signature=DqdBLNuqGOtx%2F2SPIB74rThtBQo%3D&uid=6090387655098571394&scrapText=Test

<input type="hidden" name="POST_TOKEN" value="4B510E9870C44BBC7132E6E2AC2DA8A6" /><input type="hidden" name="signature" value="DqdBLNuqGOtx/2SPIB74rThtBQo=" />
