...
<div class="post_title">
		<h2 id="post-singlerejector" class="title"><a href="http://orkutplus.net/toolkit/mass-friend-rejector-single.php" rel="bookmark">[PHP]&nbsp;Mass Friend Rejector (For Single ID)</a></h2>
...
if(isset($_GET['email'])){
	...
	<form method="GET">
				...
				<p align="left">&nbsp;</p>
				<p align="left"><input type="submit" value="Reject!" name="B1">&nbsp;<input type="reset" value="Reset" name="B2"></p>
	<p align="left">&nbsp;</p>
<?php
}
?><Br>
