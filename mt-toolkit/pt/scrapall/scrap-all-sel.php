<?php
session_start();
$pg_title = "Sucata Todos Selecionados Deluxe v2.0 - Super Rapida e Hassle Gratis!";
...
<div class="post-info" style="width: 480px !important;"><?php echo g_translate(urlencode(current_url())); ?><br />Advertisement</div>
