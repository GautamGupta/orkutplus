...
<h2 id="post-backupscraps" class="title"><a href="http://orkutplus.net/toolkit/scraps-backupmate.php" rel="bookmark">[PHP]&nbsp;Scraps BackupMate</a></h2>
...
?>
		<form method="POST">
				...
				<p align="left">&nbsp;</p>
                (Please wait untill the page gets fully loaded. It will also stop if Orkut displays "no more scraps".)
                <p align="left">&nbsp;</p>
