<?php
$pg_title = "Multiple Community Unjoiner (Non - Series)";
...
<?php
if($_POST['ids'] != NULL && $_POST['cmm'] != NULL){
	load_curl();
	...
	foreach($ids as $id){
		...
		if ($user_inf['ud_post_token'] != NULL)
		{
			for($c=0;$c<$ssepc;$c++)
			{
				...
				echo $c_email.": Community - <a href=\"http://www.orkut.com/Community.aspx?cmm=".$sepc[$c]."\">".$sepc[$c]."</a> Unjoined<br />";
				sleep(1);
			}
		}
		else
...
<div class="loltitleclassic"><b>Communities to Unjoin (Separted with &quot;:&quot; [without quotes])</b></div>
