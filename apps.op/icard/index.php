...
<head>
   ...
   //icard values need to be changed at line 295,296,297 to the icard directory with full url
   var read_val;
...
<div id="info">
Welcome to <b>Orkut iCard Generator!</b> Please have a look at the text below. :-)<br>
...
<p align="center"><img src="preview/set1/scene.gif"> <img src="preview/set2/scene.gif"> <img src="preview/set3/scene.gif"></p>
...
<div id="1set">
<a href="images/set1/card-1.gif" rel="lightbox"><img src="preview/set1/scene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-2.gif" rel="lightbox[roadtrip]"><img src="preview/set1/bluescene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-3.gif" rel="lightbox[roadtrip]"><img src="preview/set1/brownscene.gif"></a>
<br>
...
<br>
<a href="images/set1/card-4.gif" rel="lightbox[roadtrip]"><img src="preview/set1/greenscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-5.gif" rel="lightbox[roadtrip]"><img src="preview/set1/lightgreenscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-6.gif" rel="lightbox[roadtrip]"><img src="preview/set1/orangescene.gif"></a>
<br>
...
<br>
<a href="images/set1/card-7.gif" rel="lightbox[roadtrip]"><img src="preview/set1/pinkscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-8.gif" rel="lightbox[roadtrip]"><img src="preview/set1/redscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set1/card-9.gif" rel="lightbox[roadtrip]"><img src="preview/set1/yellowscene.gif"></a>
<br>
...
<a href="images/set2/card-1.gif" rel="lightbox[roadtrip]"><img src="preview/set2/scene.gif"></a>
&nbsp;&nbsp;
<a href="images/set2/card-2.gif" rel="lightbox[roadtrip]"><img src="preview/set2/greenscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set2/card-3.gif" rel="lightbox[roadtrip]"><img src="preview/set2/brownscene.gif"></a>
<br>
<input type="radio" name="cardtype" value="black" id="default2">Black 
<input type="radio" name="cardtype" value="green">Green 
<input type="radio" name="cardtype" value="brown">Brown
<br>
<a href="images/set2/card-4.gif" rel="lightbox[roadtrip]"><img src="preview/set2/darkbluescene.gif"></a>
&nbsp;&nbsp;
<a href="images/set2/card-5.gif" rel="lightbox[roadtrip]"><img src="preview/set2/skybluescene.gif"></a>
&nbsp;&nbsp;
<a href="images/set2/card-6.gif" rel="lightbox[roadtrip]"><img src="preview/set2/orangescene.gif"></a>
<br>
<input type="radio" name="cardtype" value="darkblue">Dark Blue 
<input type="radio" name="cardtype" value="skyblue">Sky Blue 
<input type="radio" name="cardtype" value="orange">Orange 
<br>
<a href="images/set2/card-7.gif" rel="lightbox[roadtrip]"><img src="preview/set2/pinkscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set2/card-8.gif" rel="lightbox[roadtrip]"><img src="preview/set2/redscene.gif"></a>
&nbsp;&nbsp
<a href="images/set2/card-9.gif" rel="lightbox[roadtrip]"><img src="preview/set2/yellowscene.gif"></a>
<br><input type="radio" name="cardtype" value="pink">Pink 
<input type="radio" name="cardtype" value="red">Red 
<input type="radio" name="cardtype" value="yellow">Yellow
</div>
<div id="3set" style="display:none;">
<a href="images/set3/card-1.gif" rel="lightbox[roadtrip]"><img src="preview/set3/scene.gif"></a>
&nbsp;&nbsp;
<a href="images/set3/card-2.gif" rel="lightbox[roadtrip]"><img src="preview/set3/greenscene.gif"></a>
&nbsp;&nbsp;
<br>
<input type="radio" name="cardtype" value="black" id="default3">Black 
<input type="radio" name="cardtype" value="green">Green 
<br>
<a href="images/set3/card-3.gif" rel="lightbox[roadtrip]"><img src="preview/set3/bluescene.gif"></a>
&nbsp;&nbsp;
<a href="images/set3/card-4.gif" rel="lightbox[roadtrip]"><img src="preview/set3/whitescene.gif"></a>
&nbsp;&nbsp;
<a href="images/set3/card-5.gif" rel="lightbox[roadtrip]"><img src="preview/set3/orangescene.gif"></a>
<br>
<input type="radio" name="cardtype" value="blue">Blue 
<input type="radio" name="cardtype" value="white">White 
<input type="radio" name="cardtype" value="orange">Orange 
<br>
<a href="images/set3/card-6.gif" rel="lightbox[roadtrip]"><img src="preview/set3/pinkscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set3/card-7.gif" rel="lightbox[roadtrip]"><img src="preview/set3/redscene.gif"></a>
&nbsp;&nbsp;
<a href="images/set3/card-8.gif" rel="lightbox[roadtrip]"><img src="preview/set3/yellowscene.gif"></a>
<br>
<input type="radio" name="cardtype" value="pink">Pink 
<input type="radio" name="cardtype" value="red">Red 
<input type="radio" name="cardtype" value="yellow">Yellow
