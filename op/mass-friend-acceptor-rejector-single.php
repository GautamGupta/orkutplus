...
<div class="post_title">
		<h2 id="post-acceptrejectsingle" class="title"><a href="http://orkutplus.net/toolkit/mass-friend-acceptor-rejector-single.php" rel="bookmark">[PHP]&nbsp;Mass Friend Acceptor / Rejector [For single ID]</a></h2>
...
if(isset($_GET['email'])){
	...
	preg_match("/orkut_state=[^;]*/i", $req->getResponseHeader('Set-Cookie'), $orkut_state);
        if ($orkut_state[0] != NULL)
        {
                ...
                if ($nowtb != NULL){
                        ...
                        $req->setRequestHeader("Cookie",$orkut_state[0]);
                        $req->send(null);
                        preg_match('/action\=\"\/Home\.aspx\"\ id\=\"friendRequestAction(.*?)\"\ target\=\"\_self\"/i', $req->responseText,$loltest);
                        ...
                        for($x=1;$x<=$nowtb;$x++)
                        {
                                ...
                                if($_GET['accept'] == "1")
                                {
                                        ...
                                        echo "UID - <a href='http://www.orkut.com/Profile.aspx?uid={$lol3[$x][1]}'>".$lol3[$x][1]."</a> Accepted<br>";
                                }else{
                                        $req->send(a."declineFriend=Submit+Query");
                                        echo "UID - <a href='http://www.orkut.com/Profile.aspx?uid={$lol3[$x][1]}'>".$lol3[$x][1]."</a> Rejected<br>";
                                }
                        }
                        ?><textarea><pre><? print_r($lol3); ?></pre></textarea><?
                        echo $loltest[1];
                }else{
	...
	<form method="GET">
				<p align="left">&nbsp;</p>
				<p align="left"><font size="2" face="Tahoma">EMail ID:
        ...
        <p aligh="left"><input type="radio" name="accept" value="2">Reject</p>
				<p align="left">&nbsp;</p>
				<p align="left"><input type="submit" value="Accept!" name="B1">&nbsp;<input type="reset" value="Reset" name="B2"></p>
	<p align="left">&nbsp;</p>
<?php
}
?><Br>
