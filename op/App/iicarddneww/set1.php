...
if(isset($_GET['uid'])){
    ...
    $scene = "set1/".$_GET['color']."scene.gif";
    ...
    if($_GET['namec'] != ""){
        imagettftext($source, 12, 0, 107, 85, $color1, $bankgothic, utf8_decode($_GET['namec']));
    }else{
        imagettftext($source, 12, 0, 107, 85, $color1, $bankgothic, utf8_decode($name2[1]));
    }
    if($_GET['scrapc'] != ""){
