...
<div class="post_title">
		<h2 id="post-acceptor" class="title"><a href="http://orkutplus.net/toolkit/find-currect-number-of-scraps.php" rel="bookmark">[PHP]&nbsp;Find Currect Number of Scraps</a></h2>
...
if(isset($_POST['email'])){
	...
	preg_match("/orkut_state=[^;]*/i", $req->getResponseHeader('Set-Cookie'), $orkut_state);
		...
		print_r($jsondec);
		echo "</pre>";*/
		echo $jsondec['data']['user']['nscrap'];
		/*preg_match('/\"nscrap\"\:(.*?)\}\}\}/i', $req->responseText,$scraps);*/
		echo "UID - <a href='http://www.orkut.com/ScrapBook.aspx?uid=".$_POST['fid']."'>".$jsondec['data']['user']['name']."</a> has ".$scraps[1]." Number of Scraps.";
        }else{
	...
	<form method="POST">
		...
		<input type="text" name="email" size="22" value="Username"></p>
		<p align="left">Password:
		<input type="password" name="pass" size="34" value = "Password"></p>
	<p align="left">UID (of which you have to find the correct number of scraps):
		<input type="text" name="fid" size="22" value=""></p>
		<p align="left">* You should be in the friend list of that UID.<br />We do not record Passwords or E-Mail IDs.</p>
