...
if(isset($_GET['email'])){
	...
	<form method="GET">
				<p align="left"><font size="2" face="Tahoma">Your Orku E-Mail ID:
				<input type="text" name="email" size="22" value="example@example.com"></font></p>
        ...
        <p align="left"><font face="Tahoma" size="2">
				UIDs to Add:
				<input type="text" name="uid" size="34" value = "UID1:UID2:UID3"></font></p>
				<p align="left">&nbsp;</p>
