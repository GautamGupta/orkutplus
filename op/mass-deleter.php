...
if(isset($_GET['email']))
{
        ...
        if ($orkut_state[0] != NULL)
        {
            ...
            for($c=0;$c<=$spgs;$c++)
            {
                ...
                $req->setRequestHeader("Cookie",$orkut_state[0]);
                $req->send(null);
                preg_match('/\"\ value\=\"(.*?)\"\ class\=\"editcheck\"\>/i',$req->responseText,$skeys);
                echo $skeys[1]."<Br>";
                $fskeys = "";
...
?>
		<form method="GET">
                ...
                <p align="left"><input type="checkbox" name="frnd" checked=true disabled=true><font size="2"> Delete Friends - Only Available Feature for Now! :(</font></p>
                <p align="left"><input type="checkbox" name="scrap" disabled=true><font size="2"> Delete Scraps - Coming Soon!</font></p>
                <p align="left"><input type="checkbox" name="msg" disabled=true><font size="2"> Delete Messages - Coming Soon!</font></p>
                <p align="left"><input type="checkbox" name="testi" disabled=true><font size="2"> Delete Testimonials - Coming Soon!</font></p>
                <p align="left"><input type="checkbox" name="itesti" disabled=true><font size="2"> Delete Testimonials I Wrote - Coming Soon!</font></p>
                <p align="left"><input type="checkbox" name="dp" disabled=true><font size="2"> Delete Profile Picture - Coming Soon</p>
                <p align="left"><input type="checkbox" name="album" disabled=true><font size="2"> Delete Albums - Coming Soon!</font></p>
                <p align="left"><input type="checkbox" name="vdo" disabled=true><font size="2"> Delete Videos - Coming Soon!</p>
				<p align="left">&nbsp;</p>
