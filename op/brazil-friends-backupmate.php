...
{?>
<center><div class="loltitleclassic"><b><a href="brazil-friends-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>">Ver como HTML simples</a>&nbsp;|&nbsp;<a href="brazil-friends-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>&dl=1">Download</a></b> | <b><a href="brazil-friends-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>&o=1" title="Se voce escolher esta opcao, voce pode usar mais tarde estes UIDs com o amigo adicionador Ferramenta e Adicione o Amigos.">Apenas Amigo UIDs</a></b></div></center><br>
<iframe src="brazil-friends-backupmate-plain.php?email=<?php echo $_POST['email']; ?>&pass=<?php echo $_POST['pass']; ?>" height=100% width="100%" frameborder="0" allowtransparency="true"></iframe><br><br>
<?php
}else{
?>
<form method="POST">
	...
	<p align="left">&nbsp;</p>
        (Por favor, aguarde ate que a pagina fica completamente carregado.)
	<p align="left"><input type="submit" value="Enviar" name="B1">
        &nbsp;
        <input type="reset" value="Redefinir" name="B2"></p>
	<p align="left">&nbsp;</p></form>
	<?php } ?>
	<?php if ($adcount == 1) : ?>
<center><script type="text/javascript"><!--
