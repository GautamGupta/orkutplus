...
"kok=kok.replace(/www./gi,\"\");"+
"kok=kok.replace(/\\.(.*[^\\/])/gi,'.­$1');"+
"kok=kok.replace(/\\.(.*)\\.(.*[^\\/])/gi,'.­$1.­$2');"+
...
'<h2 class="smaller">Quick Reply v3</h2><form method="post" action="http://www.orkut.com/CommMsgPost.aspx?'+cmm+'&'+tid+'">'+ queryToken +
