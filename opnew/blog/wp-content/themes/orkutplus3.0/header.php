...
<title>
 <?php global $title; if($title){ echo $title." - "; }else{ wp_title(' - ', true, 'right'); } ?>
 <?php bloginfo('name'); ?>
</title>
...
<style type="text/css">
.js ul#idTabs, .js div#apps, .js div#popular, .js div#tools, .js div#recentcomments2, .js div#recent {display: none;}
</style>
