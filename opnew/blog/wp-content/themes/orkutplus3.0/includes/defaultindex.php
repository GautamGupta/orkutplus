...
<div class="post-info">Written by <?php the_author_posts_link(); ?> on <?php the_time('F jS, Y') ?> |  <?php comments_popup_link('No Comments', '1 Comment', '% Comments'); ?></div>
<div style="clear: both;"></div>
